...
def fetch_dataloader(types, params):
    ...
    train_dataloader = DataLoader(train_dataset, batch_size=8, num_workers = 2,sampler=train_sampler, shuffle=True)
    test_dataloader = DataLoader(test_dataset, batch_size=8, num_workers = 2,sampler=test_sampler, shuffle=True)
